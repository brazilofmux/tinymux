...
#define T6H_COLOR256        0x00000200UL
#define T6H_COLOR24BIT      0x00000400UL
#define T6H_OPEN_OK         0x00000800UL
...
#define T6H_POW_FREE_ATTR   0x00040000UL
