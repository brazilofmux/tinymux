...
#define T5X_AF_NOEVAL   0x00100000UL
#define T5X_AF_NONAME   0x00400000UL
#define T5X_AF_NODECOMP 0x00800000UL
...
#define T5X_TALKMODE     0x00200000UL
...
#define T5X_ALONE        0x00002000UL
#define T5X_NOEXAMINE    0x00004000UL
#define T5X_NOMODIFY     0x00008000UL
#define T5X_INDESTRUCTIBLE 0x00010000UL
#define T5X_NOEVAL       0x00020000UL
...
#define T5X_POW_LINK_ANYWHR 0x00020000UL
#define T5X_POW_DARK        0x00040000UL
...
#define T5X_POW_NO_MAIL_EXPIRE 0x00000002UL
