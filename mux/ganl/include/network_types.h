...
// Bitmask describing which ProtocolState fields changed.
using ProtocolStateChangeFlags = uint32_t;

// Individual change flags
constexpr ProtocolStateChangeFlags ProtocolStateChangeNone     = 0;
constexpr ProtocolStateChangeFlags ProtocolStateChangeEncoding = 1u << 0;
constexpr ProtocolStateChangeFlags ProtocolStateChangeWidth    = 1u << 1;
constexpr ProtocolStateChangeFlags ProtocolStateChangeHeight   = 1u << 2;
constexpr ProtocolStateChangeFlags ProtocolStateChangeBinary   = 1u << 3;
constexpr ProtocolStateChangeFlags ProtocolStateChangeEcho     = 1u << 4;
constexpr ProtocolStateChangeFlags ProtocolStateChangeSGA      = 1u << 5;
constexpr ProtocolStateChangeFlags ProtocolStateChangeEOR      = 1u << 6;
constexpr ProtocolStateChangeFlags ProtocolStateChangeAnsi     = 1u << 7;
constexpr ProtocolStateChangeFlags ProtocolStateChangeMxp      = 1u << 8;
