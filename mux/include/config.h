...
#define MANDFLAGS_V5  MANDFLAGS_V4
#define OFLAGS_V5     OFLAGS_V4

#define OUTPUT_VERSION  5
#define OUTPUT_FLAGS    (MANDFLAGS_V5|OFLAGS_V5)

#define UNLOAD_VERSION  5
#define UNLOAD_FLAGS    (MANDFLAGS_V5)
