...
// NVT input state machine states
//
...
// Socket state (used by DESC, forward-declared here for engine access)
//
...
extern int64_t fetch_idle(dbref target);
extern int64_t fetch_connect(dbref target);
...
extern const UTF8 *time_format_1(int64_t Seconds, size_t maxWidth);
extern const UTF8 *time_format_2(int64_t Seconds);
