...
ftp$>$ \emph{cd TinyMUX/tinymux-2.3/alpha/6}\\
...
mux-2.3.0.6.unix.tar.gz\\
mux-2.3.0.6.win32.bin.tar.gz\\
mux-2.3.0.6.win32.src.tar.gz\\
226 Transfer complete.\\
85 bytes received in 0.03Seconds (4.48Kbytes/sec)\\
ftp$>$ \emph{get mux-2.3.0.6.unix.tar.gz}\\
200 PORT command successful.\\
150 Opening BINARY mode data connection for mux-2.3.0.6.unix.tar.gz(859891 bytes).\\
226 Transfer complete.\\
859891 bytes received in 8.61Seconds (99.85Kbytes/sec)\\
ftp$>$ \emph{quit}\\
221\\
\$
\end{verse}
...
\texttt{\footnotesize
\begin{verse}
\$ \emph{tar xvzf mux-2.3.0.6.unix.tar.gz}
\end{verse}
}
