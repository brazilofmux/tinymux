...
- Barbarella@Pacifica for making it fun, for proving to me that MU'ing is a
  ...
  choices she made, TinyMUX 2.0 would never have happened.
...
- Virginia Legowik (Audumla) and Lilith@Sandbox for README work, initial web
  site, mailing lists, gathering the right people, asking the right questions,
  and making it possible.

- Ashen-Shugar and RhostMUSH for their bug reports and support.

- Robby Griffin (Alierak) and ChaoticMUX for bug reports.

- Lew Newby (Dragon) for his stress-testing, cross-platform builds, and bug
  reports.

- MacGuvyer@Pacifica for a Unix patch for WoD-realms which led to porting all
  of TinyMUX 2.0 back to Unix.

- Nick Gammon for the initial prototype of NT IO Completion ports.

- Judge Dredd@Pacifica for specification of WOD_REALMS.

- nails of mushpark for hosting the TinyMUX website, tarballs, and wiki.
