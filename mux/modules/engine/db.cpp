...
ATTR AttrTable[] =
{
    ...
    {T("Gmcp"),        A_GMCP,     AF_ODARK | AF_NOPROG},
    {T("Pronoun"),     A_PRONOUN,  AF_VISUAL | AF_NOPROG},
    {T("ProtectName"), A_PROTECTNAME, AF_MDARK | AF_NOPROG | AF_NOCMD | AF_WIZARD},
...
// putref, putstring, getref, getstring_noalloc and their static tables
// have moved to dbutil.cpp (libmux.so).
...
// Called after db_read and failover paths to keep SQLite metadata in
// lockstep with runtime.
//
