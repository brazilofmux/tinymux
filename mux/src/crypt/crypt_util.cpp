...
void
_ufc_setup_salt_r(const char *s, struct crypt_data *__data)
{
...
void
_ufc_mk_keytab_r(char *key, struct crypt_data *__data)
{
  ufc_long v1, v2, *k1;
  int i;
#ifdef _UFC_32_
...
void
_ufc_output_conversion_r(ufc_long v1, ufc_long v2, const char *salt, struct crypt_data *__data)
{
  int i, s, shf;
...
void
__encrypt_r(char *__block, int __edflag, struct crypt_data *__data)
{
...
void
__setkey_r(const char *__key, struct crypt_data *__data)
{
  int i,j;
  unsigned char c;
