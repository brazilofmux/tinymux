// a.cpp
//
// $Id: a.cpp,v 1.9 2001-11-22 07:05:49 sdennis Exp $
//
...
int DCL_CDECL main(int ac, char *av[])
{
    ...
    while ((ch = getchar()) != EOF)
    {
        ...
        case '>':
            ...
            for (i = 0; i < len; i++)
            {
                sslen = ((len - i) < max_len ? (len - i) : max_len);
...
// Read in a string on stdin and stuff it into the passed down array,
// observing the strange rules for attribute escaping.
//
void copyattr(char *buff)
{
    char last;
