...
LINK32=xilink.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib wsock32.lib "..\bin_release\libmux.lib" /nologo /version:2.7 /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\sqlproxy.pdb" /machine:amd64 /def:".\sqlproxy.def" /out:"$(OUTDIR)\sqlproxy.dll"
DEF_FILE= \
	".\sqlproxy.def"
LINK32_OBJS= \
	"$(INTDIR)\sqlproxy.obj" \
