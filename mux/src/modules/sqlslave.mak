...
LINK32=xilink.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib wsock32.lib "..\bin_release\libmux.lib" /nologo /version:2.7 /subsystem:console /dll /incremental:no /pdb:"$(OUTDIR)\sqlslave.pdb" /machine:amd64 /def:".\sqlslave.def" /out:"$(OUTDIR)\sqlslave.dll"
DEF_FILE= \
	".\sqlslave.def"
LINK32_OBJS= \
	"$(INTDIR)\sqlslave.obj" \
