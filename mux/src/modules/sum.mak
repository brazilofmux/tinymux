...
CPP=icl.exe
CPP_PROJ=/nologo /MT /W3 /EHsc /Ot /Oa /O3 /Oi /Ob2 /Gy /D "NDEBUG" /D "WIN32" /D "WIN64" /D "_CONSOLE" /D "UNICODE" /D "WOD_REALMS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\sum.pch" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /G7 /GF /Qprec_div /Qipo2 /Qsfalign8 /Qparallel /Qpar_threshold50 /Qunroll /c 
