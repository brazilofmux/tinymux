...
// Driver-side factory classes.
//
DEFINE_FACTORY(CConnectionManagerFactory)
DEFINE_FACTORY(CDriverControlFactory)
DEFINE_FACTORY(CPlatformFactory)  // Implemented in platform.cpp.
...
MUX_RESULT CConnectionManager::FetchIdle(dbref target, int64_t *pIdle)
{
...
MUX_RESULT CConnectionManager::FetchConnect(dbref target, int64_t *pConnect)
{
