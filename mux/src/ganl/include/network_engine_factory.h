...
public:
    ...
    /**
     * Determine whether the specified engine type can adopt pre-existing sockets.
     */
    static bool supportsConnectionAdoption(NetworkEngineType type);

    /**
     * Determine whether the specified engine type can spawn managed slave processes.
     */
    static bool supportsSlaveSpawning(NetworkEngineType type);
};
