...
Full in-process Unicode Collation Algorithm (UCA, UTS #10)
implementation using DUCET from Unicode 16.0 (`allkeys.txt`).
See `docs/design-collation.md` for the detailed six-phase design.
