...
Finally, buy a UPS. Backup, off-line. Do it. If you use WinNT, configure it,
and then leave the server alone. WinNT works best if you give it good
hardware, good drivers, a set of services to run, and then leave it the heck
alone.
\backmatter
\end{document}
