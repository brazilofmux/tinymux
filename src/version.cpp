 ...
 */
/*
 * $Id: version.cpp,v 1.5 2000-05-22 20:38:30 sdennis Exp $ 
 */
...
#ifdef BETA
#if PATCHLEVEL > 0
    sprintf(mudstate.version, "MUX Beta 9 version %s patchlevel %d #%s",
        MUX_VERSION, PATCHLEVEL, MUX_BUILD_NUM);
#else
    sprintf(mudstate.version, "MUX Beta 9 version %s #%s",
