 ...
 */
/*
 * $Id: version.cpp,v 1.1 2000-04-11 07:14:48 sdennis Exp $ 
 */
...
#ifdef BETA
#if PATCHLEVEL > 0
    sprintf(mudstate.version, "MUX Beta 7 version %s patchlevel %d #%s",
        MUX_VERSION, PATCHLEVEL, MUX_BUILD_NUM);
#else
    sprintf(mudstate.version, "MUX Beta 7 version %s #%s",
