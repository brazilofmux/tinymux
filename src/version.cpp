 ...
 */
/*
 * $Id: version.cpp,v 1.4 2000-04-29 16:08:47 sdennis Exp $ 
 */
...
#ifdef BETA
#if PATCHLEVEL > 0
    sprintf(mudstate.version, "MUX Beta 8 version %s patchlevel %d #%s",
        MUX_VERSION, PATCHLEVEL, MUX_BUILD_NUM);
#else
    sprintf(mudstate.version, "MUX Beta 8 version %s #%s",
