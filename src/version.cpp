 ...
 */
/*
 * $Id: version.cpp,v 1.8 2000-08-01 01:54:22 sdennis Exp $ 
 */
...
#ifdef BETA
#if PATCHLEVEL > 0
    sprintf(mudstate.version, "MUX Beta 11 version %s patchlevel %d #%s",
        MUX_VERSION, PATCHLEVEL, MUX_BUILD_NUM);
#else
    sprintf(mudstate.version, "MUX Beta 11 version %s #%s",
