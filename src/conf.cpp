...
//
// $Id: conf.cpp,v 1.59 2002-01-24 07:07:34 sdennis Exp $
//
...
CONF conftable[] =
{
    ...
    {"badsite_file",              cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.site_file,       NULL, SIZEOF_PATHNAME},
    {"cache_names",               cf_bool,        CA_STATIC, CA_DISABLED, &mudconf.cache_names,            NULL,               0},
    {"check_interval",            cf_int,         CA_GOD,    CA_DISABLED, &mudconf.check_interval,         NULL,               0},
    {"check_offset",              cf_int,         CA_GOD,    CA_DISABLED, &mudconf.check_offset,           NULL,               0},
    {"clone_copies_cost",         cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.clone_copy_cost,        NULL,               0},
    {"comsys_database",           cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.comsys_db,       NULL, SIZEOF_PATHNAME},
    {"command_quota_increment",   cf_int,         CA_GOD,    CA_DISABLED, &mudconf.cmd_quota_incr,         NULL,               0},
    {"command_quota_max",         cf_int,         CA_GOD,    CA_DISABLED, &mudconf.cmd_quota_max,          NULL,               0},
    {"compress_program",          cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.compress,        NULL, SIZEOF_PATHNAME},
    {"compression",               cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.compress_db,            NULL,               0},
    {"config_access",             cf_cf_access,   CA_GOD,    CA_DISABLED, NULL,                            access_nametab,     0},
    {"conn_timeout",              cf_int,         CA_GOD,    CA_DISABLED, &mudconf.conn_timeout,           NULL,               0},
    {"connect_file",              cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.conn_file,       NULL, SIZEOF_PATHNAME},
    {"connect_reg_file",          cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.creg_file,       NULL, SIZEOF_PATHNAME},
    {"crash_database",            cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.crashdb,         NULL, SIZEOF_PATHNAME},
    {"create_max_cost",           cf_int,         CA_GOD,    CA_DISABLED, &mudconf.createmax,              NULL,               0},
    {"create_min_cost",           cf_int,         CA_GOD,    CA_DISABLED, &mudconf.createmin,              NULL,               0},
    {"dark_sleepers",             cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.dark_sleepers,          NULL,               0},
    {"default_home",              cf_int,         CA_GOD,    CA_DISABLED, &mudconf.default_home,           NULL,               0},
    {"destroy_going_now",         cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.destroy_going_now,      NULL,               0},
    {"dig_cost",                  cf_int,         CA_GOD,    CA_DISABLED, &mudconf.digcost,                NULL,               0},
    {"down_file",                 cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.down_file,       NULL, SIZEOF_PATHNAME},
    {"down_motd_message",         cf_string,      CA_GOD,    CA_DISABLED, (int *)mudconf.downmotd_msg,     NULL,       GBUF_SIZE},
    {"dump_interval",             cf_int,         CA_GOD,    CA_DISABLED, &mudconf.dump_interval,          NULL,               0},
    {"dump_message",              cf_string,      CA_GOD,    CA_DISABLED, (int *)mudconf.dump_msg,         NULL,             128},
    {"postdump_message",          cf_string,      CA_GOD,    CA_DISABLED, (int *)mudconf.postdump_msg,     NULL,             128},
    {"pueblo_message",            cf_string,      CA_GOD,    CA_DISABLED, (int *) mudconf.pueblo_msg,      NULL,       GBUF_SIZE},
    {"dump_offset",               cf_int,         CA_GOD,    CA_DISABLED, &mudconf.dump_offset,            NULL,               0},
    {"earn_limit",                cf_int,         CA_GOD,    CA_DISABLED, &mudconf.paylimit,               NULL,               0},
    {"examine_flags",             cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.ex_flags,               NULL,               0},
    {"examine_public_attrs",      cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.exam_public,            NULL,               0},
    {"exit_flags",                cf_set_flags,   CA_GOD,    CA_DISABLED, (int *)&mudconf.exit_flags,      NULL,               0},
    {"exit_quota",                cf_int,         CA_GOD,    CA_DISABLED, &mudconf.exit_quota,             NULL,               0},
    {"eval_comtitle",             cf_int,         CA_GOD,    CA_DISABLED, &mudconf.eval_comtitle,          NULL,               0},
    {"events_daily_hour",         cf_int,         CA_GOD,    CA_DISABLED, &mudconf.events_daily_hour,      NULL,               0},
    {"fascist_teleport",          cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.fascist_tport,          NULL,               0},
    {"fixed_home_message",        cf_string,      CA_STATIC, CA_DISABLED, (int *)mudconf.fixed_home_msg,   NULL,             128},
    {"fixed_tel_message",         cf_string,      CA_STATIC, CA_DISABLED, (int *)mudconf.fixed_tel_msg,    NULL,             128},
    {"find_money_chance",         cf_int,         CA_GOD,    CA_DISABLED, &mudconf.payfind,                NULL,               0},
...
#ifndef WIN32
    {"fork_dump",                 cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.fork_dump,              NULL,               0},
#endif
    {"full_file",                 cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.full_file,       NULL, SIZEOF_PATHNAME},
    {"full_motd_message",         cf_string,      CA_GOD,    CA_DISABLED, (int *)mudconf.fullmotd_msg,     NULL,       GBUF_SIZE},
    ...
    {"function_invocation_limit", cf_int,         CA_GOD,    CA_DISABLED, &mudconf.func_invk_lim,          NULL,               0},
    {"function_recursion_limit",  cf_int,         CA_GOD,    CA_DISABLED, &mudconf.func_nest_lim,          NULL,               0},
    {"game_dir_file",             cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.game_dir,        NULL, SIZEOF_PATHNAME},
    {"game_pag_file",             cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.game_pag,        NULL, SIZEOF_PATHNAME},
    {"good_name",                 cf_badname,     CA_GOD,    CA_DISABLED, NULL,                            NULL,               1},
    {"guest_char_num",            cf_int,         CA_STATIC, CA_DISABLED, &mudconf.guest_char,             NULL,               0},
    {"guest_nuker",               cf_int,         CA_GOD,    CA_DISABLED, &mudconf.guest_nuker,            NULL,               0},
    {"guest_prefix",              cf_string,      CA_STATIC, CA_DISABLED, (int *)mudconf.guest_prefix,     NULL,              32},
    {"guest_file",                cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.guest_file,      NULL, SIZEOF_PATHNAME},
    {"number_guests",             cf_int,         CA_STATIC, CA_DISABLED, &mudconf.number_guests,          NULL,               0},
    {"guests_channel",            cf_string,      CA_STATIC, CA_DISABLED, (int *)mudconf.guests_channel,   NULL,              32},
    {"guest_site",                cf_site,        CA_GOD,    CA_DISABLED, (int *)&mudstate.access_list,    NULL,         H_GUEST},
    {"have_comsys",               cf_bool,        CA_STATIC, CA_DISABLED, &mudconf.have_comsys,            NULL,               0},
    {"have_mailer",               cf_bool,        CA_STATIC, CA_DISABLED, &mudconf.have_mailer,            NULL,               0},
    {"have_zones",                cf_bool,        CA_STATIC, CA_DISABLED, &mudconf.have_zones,             NULL,               0},
    {"help_file",                 cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.help_file,       NULL, SIZEOF_PATHNAME},
    {"help_index",                cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.help_indx,       NULL, SIZEOF_PATHNAME},
    {"hostnames",                 cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.use_hostname,           NULL,               0},
    {"use_http",                  cf_bool,        CA_STATIC, CA_DISABLED, &mudconf.use_http,               NULL,               0},
    {"idle_wiz_dark",             cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.idle_wiz_dark,          NULL,               0},
    {"idle_interval",             cf_int,         CA_GOD,    CA_DISABLED, &mudconf.idle_interval,          NULL,               0},
    {"idle_timeout",              cf_int,         CA_GOD,    CA_DISABLED, &mudconf.idle_timeout,           NULL,               0},
    {"include",                   cf_include,     CA_STATIC, CA_DISABLED, NULL,                            NULL,               0},
    {"indent_desc",               cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.indent_desc,            NULL,               0},
    {"initial_size",              cf_int,         CA_STATIC, CA_DISABLED, &mudconf.init_size,              NULL,               0},
    {"input_database",            cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.indb,            NULL, SIZEOF_PATHNAME},
    {"kill_guarantee_cost",       cf_int,         CA_GOD,    CA_DISABLED, &mudconf.killguarantee,          NULL,               0},
    {"kill_max_cost",             cf_int,         CA_GOD,    CA_DISABLED, &mudconf.killmax,                NULL,               0},
    {"kill_min_cost",             cf_int,         CA_GOD,    CA_DISABLED, &mudconf.killmin,                NULL,               0},
    {"lag_maximum",               cf_int,         CA_GOD,    CA_DISABLED, &mudconf.max_cmdsecs,            NULL,               0},
    {"link_cost",                 cf_int,         CA_GOD,    CA_DISABLED, &mudconf.linkcost,               NULL,               0},
    {"list_access",               cf_ntab_access, CA_GOD,    CA_DISABLED, (int *)list_names,               access_nametab,     0},
    {"lock_recursion_limit",      cf_int,         CA_WIZARD, CA_DISABLED, &mudconf.lock_nest_lim,          NULL,               0},
    ...
    {"look_obey_terse",           cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.terse_look,             NULL,               0},
    {"machine_command_cost",      cf_int,         CA_GOD,    CA_DISABLED, &mudconf.machinecost,            NULL,               0},
    {"mail_database",             cf_string_dyn,  CA_GOD,    CA_DISABLED, (int *)&mudconf.mail_db,         NULL, SIZEOF_PATHNAME},
    {"mail_expiration",           cf_int,         CA_GOD,    CA_DISABLED, &mudconf.mail_expiration,        NULL,               0},
    {"master_room",               cf_int,         CA_GOD,    CA_DISABLED, &mudconf.master_room,            NULL,               0},
    {"match_own_commands",        cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.match_mine,             NULL,               0},
    {"max_players",               cf_int,         CA_GOD,    CA_DISABLED, &mudconf.max_players,            NULL,               0},
    {"max_cache_size",            cf_int,         CA_GOD,    CA_DISABLED, (int *)&mudconf.max_cache_size,  NULL,               0},
    {"money_name_plural",         cf_string,      CA_GOD,    CA_DISABLED, (int *)mudconf.many_coins,       NULL,              32},
    {"money_name_singular",       cf_string,      CA_GOD,    CA_DISABLED, (int *)mudconf.one_coin,         NULL,              32},
    {"motd_file",                 cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.motd_file,       NULL, SIZEOF_PATHNAME},
    {"motd_message",              cf_string,      CA_GOD,    CA_DISABLED, (int *)mudconf.motd_msg,         NULL,       GBUF_SIZE},
    {"mud_name",                  cf_string,      CA_GOD,    CA_DISABLED, (int *)mudconf.mud_name,         NULL,              32},
    {"news_file",                 cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.news_file,       NULL, SIZEOF_PATHNAME},
    {"news_index",                cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.news_indx,       NULL, SIZEOF_PATHNAME},
    {"newuser_file",              cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.crea_file,       NULL, SIZEOF_PATHNAME},
    {"notify_recursion_limit",    cf_int,         CA_GOD,    CA_DISABLED, &mudconf.ntfy_nest_lim,          NULL,               0},
    {"open_cost",                 cf_int,         CA_GOD,    CA_DISABLED, &mudconf.opencost,               NULL,               0},
    {"output_database",           cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.outdb,           NULL, SIZEOF_PATHNAME},
    {"output_limit",              cf_int,         CA_GOD,    CA_DISABLED, &mudconf.output_limit,           NULL,               0},
    {"page_cost",                 cf_int,         CA_GOD,    CA_DISABLED, &mudconf.pagecost,               NULL,               0},
    {"paranoid_allocate",         cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.paranoid_alloc,         NULL,               0},
    {"parent_recursion_limit",    cf_int,         CA_GOD,    CA_DISABLED, &mudconf.parent_nest_lim,        NULL,               0},
    {"paycheck",                  cf_int,         CA_GOD,    CA_DISABLED, &mudconf.paycheck,               NULL,               0},
    {"pemit_far_players",         cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.pemit_players,          NULL,               0},
    {"pemit_any_object",          cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.pemit_any,              NULL,               0},
    ...
    {"player_listen",             cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.player_listen,          NULL,               0},
    {"player_match_own_commands", cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.match_mine_pl,          NULL,               0},
    {"player_name_spaces",        cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.name_spaces,            NULL,               0},
    {"player_queue_limit",        cf_int,         CA_GOD,    CA_DISABLED, &mudconf.queuemax,               NULL,               0},
    {"player_quota",              cf_int,         CA_GOD,    CA_DISABLED, &mudconf.player_quota,           NULL,               0},
    {"player_starting_home",      cf_int,         CA_GOD,    CA_DISABLED, &mudconf.start_home,             NULL,               0},
    {"player_starting_room",      cf_int,         CA_GOD,    CA_DISABLED, &mudconf.start_room,             NULL,               0},
    {"plushelp_file",             cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.plushelp_file,   NULL, SIZEOF_PATHNAME},
    {"plushelp_index",            cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.plushelp_indx,   NULL, SIZEOF_PATHNAME},
    {"staffhelp_file",            cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.staffhelp_file,  NULL, SIZEOF_PATHNAME},
    {"staffhelp_index",           cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.staffhelp_indx,  NULL, SIZEOF_PATHNAME},
    {"public_channel",            cf_string,      CA_STATIC, CA_DISABLED, (int *)mudconf.public_channel,   NULL,              32},
    {"wiznews_file",              cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.wiznews_file,    NULL, SIZEOF_PATHNAME},
    {"wiznews_index",             cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.wiznews_indx,    NULL, SIZEOF_PATHNAME},
    {"port",                      cf_int_array,   CA_STATIC, CA_DISABLED, (int *)&mudconf.ports,           NULL, MAX_LISTEN_PORTS},
    {"public_flags",              cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.pub_flags,              NULL,               0},
    {"queue_active_chunk",        cf_int,         CA_GOD,    CA_DISABLED, &mudconf.active_q_chunk,         NULL,               0},
    {"queue_idle_chunk",          cf_int,         CA_GOD,    CA_DISABLED, &mudconf.queue_chunk,            NULL,               0},
    {"quiet_look",                cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.quiet_look,             NULL,               0},
    {"quiet_whisper",             cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.quiet_whisper,          NULL,               0},
    {"quit_file",                 cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.quit_file,       NULL, SIZEOF_PATHNAME},
    {"quotas",                    cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.quotas,                 NULL,               0},
    {"read_remote_desc",          cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.read_rem_desc,          NULL,               0},
    {"read_remote_name",          cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.read_rem_name,          NULL,               0},
    {"register_create_file",      cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.regf_file,       NULL, SIZEOF_PATHNAME},
    {"register_site",             cf_site,        CA_GOD,    CA_DISABLED, (int *)&mudstate.access_list,    NULL,  H_REGISTRATION},
    {"allow_guest_from_registered_site", cf_bool, CA_GOD,    CA_DISABLED, &mudconf.allow_guest_from_registered_site, NULL,     1},
    {"retry_limit",               cf_int,         CA_GOD,    CA_DISABLED, &mudconf.retry_limit,            NULL,               0},
    {"robot_cost",                cf_int,         CA_GOD,    CA_DISABLED, &mudconf.robotcost,              NULL,               0},
    {"robot_flags",               cf_set_flags,   CA_GOD,    CA_DISABLED, (int *)&mudconf.robot_flags,     NULL,               0},
    {"robot_speech",              cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.robot_speak,            NULL,               0},
    {"room_flags",                cf_set_flags,   CA_GOD,    CA_DISABLED, (int *)&mudconf.room_flags,      NULL,               0},
    {"room_quota",                cf_int,         CA_GOD,    CA_DISABLED, &mudconf.room_quota,             NULL,               0},
    {"run_startup",               cf_bool,        CA_STATIC, CA_DISABLED, &mudconf.run_startup,            NULL,               0},
    {"sacrifice_adjust",          cf_int,         CA_GOD,    CA_DISABLED, &mudconf.sacadjust,              NULL,               0},
    {"sacrifice_factor",          cf_int,         CA_GOD,    CA_DISABLED, &mudconf.sacfactor,              NULL,               0},
    {"safe_wipe",                 cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.safe_wipe,              NULL,               0},
    {"safer_passwords",           cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.safer_passwords,        NULL,               0},
    {"search_cost",               cf_int,         CA_GOD,    CA_DISABLED, &mudconf.searchcost,             NULL,               0},
    {"see_owned_dark",            cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.see_own_dark,           NULL,               0},
    {"signal_action",             cf_option,      CA_STATIC, CA_DISABLED, &mudconf.sig_action,             sigactions_nametab, 0},
    {"site_chars",                cf_int,         CA_GOD,    CA_DISABLED, (int *)&mudconf.site_chars,      NULL,               0},
    {"space_compress",            cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.space_compress,         NULL,               0},
    {"stack_limit",               cf_int,         CA_GOD,    CA_DISABLED, &mudconf.stack_limit,            NULL,               0},
    {"starting_money",            cf_int,         CA_GOD,    CA_DISABLED, &mudconf.paystart,               NULL,               0},
    {"starting_quota",            cf_int,         CA_GOD,    CA_DISABLED, &mudconf.start_quota,            NULL,               0},
    {"status_file",               cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.status_file,     NULL, SIZEOF_PATHNAME},
    {"suspect_site",              cf_site,        CA_GOD,    CA_DISABLED, (int *)&mudstate.suspect_list,   NULL,       H_SUSPECT},
    {"sweep_dark",                cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.sweep_dark,             NULL,               0},
    {"switch_default_all",        cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.switch_df_all,          NULL,               0},
    {"terse_shows_contents",      cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.terse_contents,         NULL,               0},
    {"terse_shows_exits",         cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.terse_exits,            NULL,               0},
    {"terse_shows_move_messages", cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.terse_movemsg,          NULL,               0},
    {"thing_flags",               cf_set_flags,   CA_GOD,    CA_DISABLED, (int *)&mudconf.thing_flags,     NULL,               0},
    {"thing_quota",               cf_int,         CA_GOD,    CA_DISABLED, &mudconf.thing_quota,            NULL,               0},
    {"timeslice",                 cf_int,         CA_GOD,    CA_DISABLED, &mudconf.timeslice,              NULL,               0},
    {"toad_recipient",            cf_int,         CA_GOD,    CA_DISABLED, &mudconf.toad_recipient,         NULL,               0},
    {"trace_output_limit",        cf_int,         CA_GOD,    CA_DISABLED, &mudconf.trace_limit,            NULL,               0},
    {"trace_topdown",             cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.trace_topdown,          NULL,               0},
    {"trust_site",                cf_site,        CA_GOD,    CA_DISABLED, (int *)&mudstate.suspect_list,   NULL,               0},
    {"uncompress_program",        cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.uncompress,      NULL, SIZEOF_PATHNAME},
    {"unowned_safe",              cf_bool,        CA_GOD,    CA_DISABLED, &mudconf.safe_unowned,           NULL,               0},
    {"user_attr_access",          cf_modify_bits, CA_GOD,    CA_DISABLED, &mudconf.vattr_flags,            attraccess_nametab, 0},
    {"wait_cost",                 cf_int,         CA_GOD,    CA_DISABLED, &mudconf.waitcost,               NULL,               0},
    {"wizard_help_file",          cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.whelp_file,      NULL, SIZEOF_PATHNAME},
    {"wizard_help_index",         cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.whelp_indx,      NULL, SIZEOF_PATHNAME},
    {"wizard_motd_file",          cf_string_dyn,  CA_STATIC, CA_DISABLED, (int *)&mudconf.wizmotd_file,    NULL, SIZEOF_PATHNAME},
    {"wizard_motd_message",       cf_string,      CA_GOD,    CA_DISABLED, (int *)mudconf.wizmotd_msg,      NULL,       GBUF_SIZE},
    {"zone_recursion_limit",      cf_int,         CA_GOD,    CA_DISABLED, &mudconf.zone_nest_lim,          NULL,               0},
    { NULL,                       NULL,           0,         CA_DISABLED, NULL,                            NULL,               0}
};
