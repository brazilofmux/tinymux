...
/* $Id: command.h,v 1.5 2001-03-31 04:48:59 sdennis Exp $ */
...
typedef struct
{
    ...
    int     extra;
    int     callseq;
    void    (*handler)(dbref, dbref, int, char *);
} CMDENT_ONE_ARG;
...
typedef struct
{
    ...
    int     extra;
    int     callseq;
    void    (*handler)(dbref, dbref, int, char *, char *[], int);
...
typedef struct
{
    ...
    int     extra;
    int     callseq;
    void    (*handler)(dbref, dbref, int, char *, char *, char*[], int);
...
typedef struct
{
    ...
    int     extra;
    int     callseq;
    void    (*handler)(dbref, dbref, int, char *, char *[], int, char*[], int);
