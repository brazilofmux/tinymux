...
static int Tiny_fpclass(double result)
{
    ...
    if ((u.i64 & IEEE_MASK_EXPONENT) == 0)
    {
        ...
        {
            if (u.i64 & IEEE_MASK_SIGN) return TINY_FPCLASS_ND;
            else                        return TINY_FPCLASS_PD;
        }
        else
        {
            if (u.i64 & IEEE_MASK_SIGN) return TINY_FPCLASS_NZ;
    ...
    else if ((u.i64 & IEEE_MASK_EXPONENT) == IEEE_MASK_EXPONENT)
    {
        if (u.i64 & IEEE_MASK_MANTISSA)
        {
            if (u.i64 & IEEE_MASK_QNAN) return TINY_FPCLASS_QNAN;
            else                        return TINY_FPCLASS_SNAN;
        }
        else
        {
            if (u.i64 & IEEE_MASK_SIGN) return TINY_FPCLASS_NINF;
            else                        return TINY_FPCLASS_PINF;
        }
    }
    else
    {
        if (u.i64 & IEEE_MASK_SIGN)     return TINY_FPCLASS_NN;
...
FUN flist[] =
{
    ...
    {"DUMPING",  fun_dumping,  0,  0,          CA_PUBLIC},
