...
def main() -> int:
    ...
    print("#")
    # Independent of suite.list.* so a truncated list cannot make
    # SUITE-EXPECTED agree with a short dispatch and hide missing tests
    # (#1387).
    print(f"&suite.expected smoke={len(names)}")
    print("-")
