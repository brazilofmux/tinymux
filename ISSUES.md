...
| [Test Infrastructure](testcases/ISSUES.md) | 4 | SHA1→semantic migration still in progress; edge-case coverage gaps; single-test-per-function norm; no parallel multi-test execution. |
