...
// Include platform-specific engines conditionally
    ...
    #include "../epoll/epoll_network_engine.h"
    #define HAVE_EPOLL 1
#else
    #define HAVE_EPOLL 0
#endif
    ...
    #include "../kqueue/kqueue_network_engine.h"
    ...
    #include "../wselect/wselect_network_engine.h"
    #define HAVE_WSELECT 1

    // IOCP implementation
    #include "../iocp/iocp_network_engine.h"
    #define HAVE_IOCP 1
#else
    #include "../select/select_network_engine.h"
